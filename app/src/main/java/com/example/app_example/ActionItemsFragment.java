...
public class ActionItemsFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Log.i("FRAGMENT_LIFE_CYCLE", "onCreate");

    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       // Log.i("FRAGMENT_LIFE_CYCLE", "onCreateView");
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
       ...
       // Log.i("FRAGMENT_LIFE_CYCLE", "onViewCreated");
        Activity activity = getActivity();
        if(activity instanceof MainActivity || activity instanceof MainDynamic){
        ...
        view.findViewById(R.id.imageViewBack).setOnClickListener(
                new View.OnClickListener() {
                    public void onClick(View v) {
                        Intent myIntent = new Intent(getActivity().getBaseContext(), MainDynamic.class);
                        startActivity(myIntent);
                    }
                }
        );
    ...
    public void onStart() {
        super.onStart();
        //Log.i("FRAGMENT_LIFE_CYCLE", "onStart");
    }

    @Override
    public void onPause() {
        super.onPause();
       // Log.i("FRAGMENT_LIFE_CYCLE", "onPause");
    }

    @Override
    public void onResume() {
        super.onResume();
       // Log.i("FRAGMENT_LIFE_CYCLE", "onResume");
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
       // Log.i("FRAGMENT_LIFE_CYCLE", "onDestroy");
    }
    ...
    public void onAttach(Context context) {
        ...
        //Log.i("FRAGMENT_LIFE_CYCLE", "onAttach");
    }

    @Override
    public void onDetach() {
        super.onDetach();
        //Log.i("FRAGMENT_LIFE_CYCLE", "onDetach");
    }

    @Override
    public void onDestroyView() {
        super.onDestroyView();
        //Log.i("FRAGMENT_LIFE_CYCLE", "onDestroyView");
    }
}